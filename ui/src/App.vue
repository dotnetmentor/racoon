    ...
    <div class="grid">
      ...
      <div>
        <label>Right Source<br />
          <select
            v-model="source.right"
            id="right-source"
            @change="() => sourceChanged('right')"
          >
            <option :key="val" v-for="val in sources">{{ val }}</option>
          </select>
        </label>
    ...
    <section v-if="!loading">
      ...
      <div class="grid">
        <Diff
          ...
          theme="light"
          language="html"
          :prev="results.left.result"
          :current="results.right.result"
        />
      </div>
    </section>
    ...
    <section v-if="!loading">
      ...
      <div class="grid">
        <Diff
          ...
          theme="light"
          language="html"
          :prev="results.left.logs"
          :current="results.right.logs"
        />
      </div>
  </section>
  </main>
